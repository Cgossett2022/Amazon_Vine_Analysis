...
## Overview
For this project, I analyzed Amazon Reviews written by members of the paid Amazon Vine Program. The dataset I chose to look at contained reviews on Furniture and I completed the project through the following steps: 1. Created an AWS RDS database 2. Used PySpark to extract and transform the data into Colaboratory 3. Loaded the data into pgAdmin 4. Used PySpark to determine results and potential bias toward favorable reviews   
